...
public:
    ...
    void setupUi(QMainWindow *saddlebackTripWindow)
    {
        ...
        label_2->setGeometry(QRect(140, 190, 251, 41));
        QFont font2;
        ...
        label_3->setGeometry(QRect(430, 190, 251, 31));
        QFont font3;
        ...
        label_4->setGeometry(QRect(310, 120, 221, 16));
    ...
    void retranslateUi(QMainWindow *saddlebackTripWindow)
    {
        ...
        label_2->setText(QCoreApplication::translate("saddlebackTripWindow", "<html><head/><body><p align=\"center\">Menu</p></body></html>", nullptr));
        label_3->setText(QCoreApplication::translate("saddlebackTripWindow", "<html><head/><body><p align=\"center\">Receipt</p></body></html>", nullptr));
